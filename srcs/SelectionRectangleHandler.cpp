...
SelectionRectangleHandler::SelectionRectangleHandler(const IRendering* rendering)
{
...
void SelectionRectangleHandler::DrawSelectionRectangle(IFrameRenderer& frameRenderer) const
{
    if (IsSelecting())
    {
